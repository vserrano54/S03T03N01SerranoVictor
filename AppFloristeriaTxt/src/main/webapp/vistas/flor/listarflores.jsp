...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h3 class="mb-3 mt-3">Lista de Flores</h3>
   
      
     <a href="FlorController?accion=agregar"  type="button" class="btn btn-primary mb-3"><i class="fa-regular fa-file"></i> Agregar</a>  
				...
				<tbody>
					...
					<C:forEach var="item" items="${lista}">
						...
						<tr>
							...
							<td> <C:out value="${item.getColor()}"></C:out> </td>
							<td>
							
							<a href="FlorController?accion=editar&codigo=<C:out value="${item.getCodigo()}"></C:out>"  class="btn btn-success mt-3"><i class="fa-solid fa-pen-to-square"></i></a>
							<a href="FlorController?accion=eliminar&codigo=<C:out value="${item.getCodigo()}"></C:out>"  class="btn btn-danger mt-3"><i class="fa-solid fa-trash-can"></i></a>
