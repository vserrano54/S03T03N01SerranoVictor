...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h3 class="mb-3 mt-3 ml-5">Registro de Flores</h3>
      
      <div class="col-sm-6 ml-5">
      
        <form name="frmUsuario" method="post" autocomplete="off" action="FlorController?accion=guardar" >
		...
		<button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Guardar un nuevo registro"><i class="fa-solid fa-floppy-disk"></i> Guardar</button>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="color" name="txtColor" required
