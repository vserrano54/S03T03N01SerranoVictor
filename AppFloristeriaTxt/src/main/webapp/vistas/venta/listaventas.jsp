...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h3 class="mb-3 mt-3">Lista de Facturas de Ventas Registradas</h3>
   
      
     <a href="VentaController?accion=registrar"  type="button" class="btn btn-primary mb-3"><i class="fa-regular fa-file"></i> Registrar Venta</a>  
       
      
      <div class="col-sm-12 mt-3" id="listaVenta">
				...
				<tbody>
					...
					<C:forEach var="item" items="${lista}">
						...
						<tr>
							...
							<a href="VentaController?accion=visualizar&codigo=<C:out value="${item.getCodigo()}"></C:out>"  class="btn btn-success mt-3"><i class="fa-solid fa-eye"></i></a>
