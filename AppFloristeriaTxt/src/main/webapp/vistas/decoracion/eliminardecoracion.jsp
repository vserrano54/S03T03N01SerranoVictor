  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <h3 class="mb-3 mt-3 ml-5">Eliminar Decoración</h3>
       
      <div class="col-sm-6 ml-5">
        <form name="frmDecoracion" method="post" action="DecoracionController?accion=eliminar" >
		...
		<div class="form-group" >
	      ...
	      <select id="tipomaterial" class="form-control" name="txtTipoMaterial" disabled>
	        <option>Sleccione el tipo de material</option>
				...
				<option value="5" <%= tipomat == 5 ? "selected": ""%>>Hojas de eucalipto baby</option>
		  		...
		  		<option value="10" <%= tipomat == 10 ? "selected": ""%>>Cineraria marítima</option>
		  		<option value="11" <%= tipomat == 11 ? "selected": ""%>>Sorgo</option>
		  		<option value="12" <%= tipomat == 12 ? "selected": ""%>>Tepozán</option>
	      </select>
    	</div>
