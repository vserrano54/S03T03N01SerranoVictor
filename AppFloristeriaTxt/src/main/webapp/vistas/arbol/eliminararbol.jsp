  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <h3 class="mb-3 mt-3 ml-5">Eliminar Arbol</h3>
       
      <div class="col-sm-6 ml-5">
        <form name="frmUsuario" method="post" action="ArbolController?accion=eliminar" >
		...
		<div class="form-group">
			<label for="txtAltura">Altura</label> <input
				type="text" class="form-control" id="altura" name="txtAltura" disabled
