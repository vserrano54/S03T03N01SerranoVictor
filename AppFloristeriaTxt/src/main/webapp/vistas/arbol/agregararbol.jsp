...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h3 class="mb-3 mt-3 ml-5">Agregar de Arbol</h3>
      
      <div class="col-sm-6 ml-5">
      
        <form name="frmUsuario" method="post" action="ArbolController?accion=guardar" >
		...
		<div class="form-group">
			<label for="txtAltura">Altura</label> <input
				type="text" class="form-control" id="altrua" name="txtAltura" required
