...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
	 ...
	 <h3 class="mb-3 mt-3 ml-5">Registro de Factura de compra</h3>
	 
	 <form name="frmCompra" method="post" action="ArbolController?accion=guardar" >
   ...
   <!--  /****************************************************************************************** -->
      ...
      <div class="row">
       ...
       <div class="row">
		...
		<a href="CompraController?accion=registrar"  class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Nuevo Rregistro"><i class="fa-solid fa-file"></i> Nuevo</a>
		<a href="CompraController?accion=listar"  class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Regresar a la lista de Compras"><i class="fa-solid fa-reply"></i> Regresar</a>
	</form>
   </div>
