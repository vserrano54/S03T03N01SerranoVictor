...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h3 class="mb-3 mt-3">Lista de Facturas de Compras Registradas</h3>
   
      
     <a href="CompraController?accion=registrar"  type="button" class="btn btn-primary mb-3"><i class="fa-regular fa-file"></i> Registrar Compra</a>  
       
      
      <div class="col-sm-12 mt-3" id="listaCompra">
				...
				<tbody>
					...
					<C:forEach var="item" items="${lista}">
						...
						<tr>
							...
							<td> <C:out value="${item.getFactura()}"></C:out> </td>
							<td> <C:out value="${item.getFecha()}"></C:out> </td>
				
							<td>
							
							<a href="CompraController?accion=visualizar&codigo=<C:out value="${item.getCodigo()}"></C:out>"  class="btn btn-success mt-3"><i class="fa-solid fa-eye"></i></a>
