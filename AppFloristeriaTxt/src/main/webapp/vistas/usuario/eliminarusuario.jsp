  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <h3 class="mb-3 mt-3 ml-5">Eliminar Usuario</h3>
       
      <div class="col-sm-6 ml-5">
        <form name="frmUsuario" method="post" action="UsuarioController?accion=eliminar" >
        
     
        
		<input type="hidden" class="form-control" id="codigo" name="codigo"
				value="<C:out value="${usuario.getCodigo()}"></C:out>">
		...
		<div class="form-group">
			<label for="nombre">Nombre</label> <input
				...
				value="<C:out value="${usuario.getNombre()}"></C:out>">
		</div>
		
		<div class="form-group">
			<label for="usuario">Usuario</label> <input
				type="text" class="form-control" id="usuario" name="txtUsuario" disabled
				placeholder="Ingresa el usuario"
				value="<C:out value="${usuario.getUser()}"></C:out>">
		</div>
		
		<div class="form-group">
			<label for="password">Password</label> <input
				type="password" class="form-control" id="password" name="txtPassword" disabled
				placeholder="Password"
				value="<C:out value="${usuario.getPassword()}"></C:out>">
		</div>
		
		<div class="form-group">
			<label for="correo">Correo</label> <input
				type="email" class="form-control" id="correo" name="txtCorreo" disabled
				placeholder="Ingrese el correo"
				value="<C:out value="${usuario.getCorreo()}"></C:out>">
		</div>
		
		
		<div class="form-group form-check">
			<input type="checkbox" class="form-check-inputs" name="chkEstado" id="chkEstado" disabled>
			<label class="form-check-label" for="estado">Activo</label>
		</div>
		
		<button type="submit" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> Eliminar</button>
		<a href="UsuarioController?accion=listar"  class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Regresar a la lista de Usuario"><i class="fa-solid fa-reply"></i> Regresar</a>
	</form>
	</div>
