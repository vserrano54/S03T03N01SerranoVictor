...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <h3 class="mb-3 mt-3 ml-5">Registro de Usuario</h3>
      
      <div class="col-sm-6 ml-5">
      
        <form name="frmUsuario" method="post" action="UsuarioController?accion=guardar" >
		...
		<div class="form-group">
			<label for="usuario">Usuario</label> <input
				type="text" class="form-control" id="usuario" name="txtUsuario" required
				placeholder="Ingresa el usuario">
		</div>
		
		<div class="form-group">
			<label for="password">Password</label> <input
				type="password" class="form-control" id="password" name="txtPassword" required
				placeholder="Password">
		</div>
		
		<div class="form-group">
			<label for="txtCorreo">Correo</label> 
			<input type="email" class="form-control" id="correo" name="txtCorreo" required
				placeholder="Ingrese el correo">
		</div>
		
		<div class="form-group form-check">
			<input type="checkbox" class="form-check-inputs" name="chkEstado" checked>
