  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       ...
       <h3 class="mb-3 mt-3 ml-5">Editar Usuario</h3>
      
      	<div class="col-sm-6 ml-5">
      	
        <form name="frmUsuario" method="post" action="UsuarioController?accion=editar" >
		...
		<div class="form-group">
			<label for="usuario">Usuario</label> <input
				type="text" class="form-control" id="usuario" name="txtUsuario"
		...
		<div class="form-group">
			<label for="correo">Correo</label> <input
				type="email" class="form-control" id="correo" name="txtCorreo"
		...
		<div class="form-group form-check">
			<input type="checkbox" class="form-check-inputs" name="chkEstado" id="chkEstado">
