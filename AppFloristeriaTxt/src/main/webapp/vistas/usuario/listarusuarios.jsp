  ...
  <div class="d-flex" id="wrapper">
   ...
   <!-- Sidebar -->
    ...
    <div id="page-content-wrapper">
      ...
      <h3 class="mb-3 mt-3">Lista de Usuario</h3>
   
      
     <a href="UsuarioController?accion=agregar"  type="button" class="btn btn-primary mb-3"><i class="fa-regular fa-file"></i> Agregar</a>  
				...
				<tbody>
					...
					<C:forEach var="item" items="${lista}">
						...
						<tr>
							...
							<td> <C:out value="${item.getCorreo()}"></C:out> </td>
							<td> <C:out value="${item.getEstado()}"></C:out> </td>
							<td>
							
							<a href="UsuarioController?accion=editar&codigo=<C:out value="${item.getCodigo()}"></C:out>"  class="btn btn-success mt-3"><i class="fa-solid fa-pen-to-square"></i></a>
							<a href="UsuarioController?accion=eliminar&codigo=<C:out value="${item.getCodigo()}"></C:out>"  class="btn btn-danger mt-3"><i class="fa-solid fa-trash-can"></i></a>
