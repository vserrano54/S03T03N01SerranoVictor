...
/*
listaArboles.forEach(function(arbol) {
    console.log("Nombre: " + arbol.nombre + ", precio: " + arbol.precio);
});


listaFlores.forEach(function(flor) {
    console.log("Nombre: " + flor.nombre + ", precio: " + flor.precio);
});

listaDecoraciones.forEach(function(decoracion) {
    console.log("Nombre: " + decoracion.nombre + ", precio: " + decoracion.precio);
});
*/
...
function eliminar(linea){
 ...
 function enviarDatos() {
            ...
            xhttp.open("POST", "CompraController", true);
